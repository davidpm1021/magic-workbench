...
import { DESKTOP_BATTLEFIELD_LAYOUT } from "./board/battlefieldLayoutPolicy";
...
export type DesktopBoardCanvasProps = Omit<
  BoardCanvasProps,
  "layoutPolicy" | "mobileHandOpen" | "mobileHandPeek" | "mobileHandControlBounds"
>;
